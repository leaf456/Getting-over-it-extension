    ...
    try {
      ...
      scaffolding.setUsername("griffpatch".replace(/#/g, () => Math.floor(Math.random() * 10)));
      scaffolding.setAccentColor("#d1c633");

      scaffolding.addCloudProvider(new Scaffolding.Cloud.LocalStorageProvider("cloudvariables:389464290"));
      ...
      if (false && (document.fullscreenEnabled || document.webkitFullscreenEnabled)) {
        ...
        const fillColor = otherControlsExist ? '#575E75' : '#ff0000';
